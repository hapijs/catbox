...
// Noop for missing callbacks

var noop = function () { };


module.exports = internals.Policy = function (options, cache, segment) {
...
internals.Policy.prototype.getOrGenerate = function (id, generateFunc, callback) {
    ...
    var validate = function (cached) {
        ...
        if (cached &&
            ...
            return nextTick(function(){
                callback(null, cached.item, cached, report);
            });
        }
        ...
        generateFunc(function (err, result, isUncacheable) {
            ...
            if (err ||
                ...
                return nextTick(function(){
                    callback(err, result, null, report);
                });
            }
            ...
            return nextTick(function(){
                callback(null, result, null, report);
            });
        });
    };
...
internals.Policy.compile = function (options, serverSide) {
    ...
    Hoek.assert(!!options.expiresIn ^ !!options.expiresAt, 'Rule must include one of expiresIn or expiresAt but not both');                                                // XOR
