...
internals.Client.prototype.dropSegment = function (segment, callback) {
    ...
    if (typeof this.connection.dropSegment !== 'function') {
        return callback(Boom.internal('Client does not support dropSegment'));
    }

    this.connection.dropSegment(segment, callback);
};
